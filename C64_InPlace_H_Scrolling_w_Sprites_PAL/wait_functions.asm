...
wait_one_bad_line_minus_3: //+6
  ...
  rts //+6
wait_one_bad_line_minus_5_minus_3: //+6
  :cycles(-6+23-3-5-6) //20-5-12
  rts //+6
...
wait_one_good_line_minus_5: //+6
  :cycles(-6+63-5-6) // 63-5-12
  rts //+6
...
wait_one_good_line_minus_5_minus_jsr_and_rts: //+6
  :cycles(-6-6+63-5-6-6) // 63-5-24
  rts //+6
...
wait_6_good_lines_minus_5: //+6
  jsr wait_one_good_line_minus_5 // 1: 63-12+6+6 = 63
  jsr wait_one_good_line_minus_5 // 2: 63-12+6+6 = 63
  jsr wait_one_good_line_minus_5 // 3: 63-12+6+6 = 63
  jsr wait_one_good_line_minus_5 // 4: 63-12+6+6 = 63
  jsr wait_one_good_line_minus_5 // 5: 63-12+6+6 = 63
  // 6: Wait_one_good_line minus 24 cycles for 2 jsrs and 2 rtses.
  jsr wait_one_good_line_minus_5_minus_jsr_and_rts // 6: 63-12
  rts //+6

// Wait one entire row worth of cycles minus the 12 cycles to call this function.
wait_1_row_minus_5: //+6
  jsr wait_one_bad_line_minus_5_minus_3 // 23-3-5 = 15
  jsr wait_6_good_lines_minus_5 // 63*5 + 63-12+6+6 = 63*6
  // Wait_one_good_line minus 24 cycles for 2 jsrs and 2 rtses.
  jsr wait_one_good_line_minus_5_minus_jsr_and_rts // 63-12
  rts //+6
